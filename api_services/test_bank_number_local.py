...
url = "http://localhost:8080/v1/transfers/banks"
headers = {
...
# Average latency: ~0.42 for single request

# Average latency: 0.4270342779159546 for 2 concucrrent requests

# Average latency: 0.7004646539688111 for 4 concurrent requests

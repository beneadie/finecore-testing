...
url = "http://api.finecore.co/v1/transfers/account"
headers = {
...
#Average latency: 0.5475723457336426 for single request

#Average latency: 0.5870540380477905 for 2 concucrrent requests

#Average latency: 0.9141815042495728 for 4 concurrent requests
